...
import com.lamz.marvelapp.ui.components.CartItem
import com.lamz.marvelapp.ui.components.OrderButton
...
fun CartContent(
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(state.marvelData, key = { it.marvel.id }) { item ->
                CartItem(
                    rewardId = item.marvel.id,
                    image = item.marvel.image,
                    title = item.marvel.title,
                    totalPoint = item.marvel.requiredPoint * item.count,
                    count = item.count,
        ...
        OrderButton(
            ...
            enabled = state.marvelData.isNotEmpty(),
            onClick = {
